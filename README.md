...
四人数字麻将 Web 与微信小程序游戏。微信小程序支持持久微信账号、一键四真人竞技匹配、长期段位和竞技成就；好友房支持真人与机器人混合入座，人机模式由一位真人与三位机器人对战。项目暂不包含金币钱包、充值、赛季、排行榜或回放。
...
- 微信账号支持四真人快速匹配：固定底分 2、20 秒出牌、按等待时间逐步放宽段位范围，单小局结算后可继续匹配。
- 竞技段位从黑铁Ⅴ到雀神等级，胡牌与实际赔付倍率决定升降；低段免降并支持首次晋段保护卡。
- 快速匹配永久累计明杠、碰亮牌、补杠和暗杠成就；牌桌资料卡可查看公开段位与成就。
